...
class SMK25(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for SMK25 in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in SMK25._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in SMK25._active_instances:    # Make sure you update the name
            SMK25._active_instances.append(self)   # Make sure you update the name
            SMK25._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in SMK25._active_instances) and SMK25._active_instances.remove(self):    # Make sure you update the name
    ...
    def _setup_device_and_transport_control(self):
        ...
        play_button = ButtonElement(True, MIDI_CC_TYPE, 0, 102)
        stop_button = ButtonElement(True, MIDI_CC_TYPE, 0, 103)
        rec_button = ButtonElement(True, MIDI_CC_TYPE, 0, 104)

        # Optionally clear old ones from the map
        self._note_map[93] = None
        self._note_map[94] = None
        self._note_map[95] = None
