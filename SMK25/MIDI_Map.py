...
BUTTONCHANNEL = 9  # Channel assignment for all mapped buttons/pads; valid range is 0 to 15 ; 0=1, 1=2 etc.
...
# General
PLAY = -1 #94   # Global play
STOP = -1 #93   # Global stop
REC = -1 #95    # Global record

TAPTEMPO = -1   # Tap tempo
NUDGEUP = 6    # Tempo Nudge Up
NUDGEDOWN = 5  # Tempo Nudge Down
UNDO = 1   # Undo
REDO = 2   # Redo
LOOP = -1   # Loop on/off
PUNCHIN = -1    # Punch in
...
METRONOME = 3   # Metronome on/off
RECQUANT = -1   # Record quantization on/off
DETAILVIEW = 7   # Detail view switch
CLIPTRACKVIEW = 8  # Clip/Track view switch
...
PADCHANNEL = 9  # MIDI channel for Drum Rack notes
DRUM_PADS = (96, 97, 91, 92,
              0,  1,  2,  3,
             -1, -1, -1, -1,
             -1, -1, -1, -1)
...
TEMPO_TOP = 360  # Upper limit of tempo control in BPM (max is 999)
TEMPO_BOTTOM = 1  # Lower limit of tempo control in BPM (min is 0)

TEMPOCONTROL = 25  # Tempo control CC assignment; control range is set above
MASTERVOLUME = 27  # Master track volume
CUELEVEL = -1  # Cue level control
CROSSFADER = -1  # Crossfader control

TRACKVOL = ( 20,  # Track 1 Volume
             21,  # Track 2
             22,  # Track 3
             23,  # Track 4
            -1,  # Track 5
